...
function AboutMe() {
    ...
    return (
        <div className='aboutMe justify-content-center align-items-center'>
            ...
            <h3>
                JavaScript | TypeScript | MERN Stack | HTML | NodeJS | JSON | JQuery | ExpressJS | Handlebars | JWT | MySQL | MongoDB | GraphQL | Apollo 
            </h3>
            <h3>
                React | NextJS | DaisyUI | CSS | Tailwind CSS | Bootstrap | Bulma | Figma | Netlify | Swiper | GSAP    
            </h3>
